"""Service functions for admin workflows."""
...
async def get_dashboard_stats_service(db: AsyncSession) -> APIResponse[dict[str, Any]]:
...
async def get_all_users_service(
    ...
    users = [_user_to_list_item(user) for user in result[USERS_KEY]]
    return APIResponse.success_response(
