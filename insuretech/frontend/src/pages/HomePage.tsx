...
function HomePage() {
  ...
  const insuranceCategories = [
    {
      ...
      icon: (
        <path d="M12 2c1 4-3 5-3 9a4 4 0 0 0 8 0c0-2-1-3-1-3s1 3-1 4c1-3-2-4-1-7-2 1-3 3-3 5a3 3 0 0 0 0 .2C9.5 12 8 9.5 8 7c0-2 2-4 4-5z" />
      ),
    },
    {
      ...
      icon: (
        <path d="M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6zM19.4 13a7.4 7.4 0 0 0 .1-2l2-1.5-2-3.4-2.3.9a7.6 7.6 0 0 0-1.7-1l-.3-2.5H9.8l-.3 2.5a7.6 7.6 0 0 0-1.7 1l-2.3-.9-2 3.4 2 1.5a7.4 7.4 0 0 0 0 2l-2 1.5 2 3.4 2.3-.9a7.6 7.6 0 0 0 1.7 1l.3 2.5h4.4l.3-2.5a7.6 7.6 0 0 0 1.7-1l2.3.9 2-3.4-2-1.5z" />
      ),
    },
    {
      ...
      icon: (
        <path d="M3 11l9-7 9 7v9a1 1 0 0 1-1 1h-4v-6H8v6H4a1 1 0 0 1-1-1v-9z" />
      ),
    },
    {
  ...
  const loopedCategories = [
    ...insuranceCategories,
    ...insuranceCategories.slice(0, visibleCards),
  ];
  ...
  useEffect(() => {
    ...
    const timer = setInterval(() => {
      current += 1;
      setMfgCount(
        Math.min(mfgTarget, Math.round((current / steps) * mfgTarget)),
      );
      setRetailCount(
        Math.min(retailTarget, Math.round((current / steps) * retailTarget)),
      );
    ...
    <div className="w-full max-w-[100vw] overflow-x-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              ...
              <p className="mt-5 text-lg lg:text-xl leading-relaxed text-white/70 max-w-xl">
                Our platform analyzes your business profile and recommends
                suitable insurance policies from our curated database for
            ...
            <div
              ...
              style={{
                ...
                transition:
                  "opacity 0.9s ease-out 150ms, transform 0.9s cubic-bezier(0.16,1,0.3,1) 150ms",
              }}
            >
              <svg
                viewBox="0 0 560 520"
              ...
              >
                ...
                />
                <path
                  d="M100 250 L280 150 L460 250 Z"
                ...
                <g transform="translate(380, 95)">
                  <path
                    d="M50 0L95 18V52C95 84 75 108 50 118C25 108 5 84 5 52V18L50 0Z"
                    fill="var(--color-cta)"
                  />
                  <path
                    d="M30 60L44 75L72 42"
                    stroke="white"
                    strokeWidth="6"
                    strokeLinecap="round"
                    strokeLinejoin="round"
      ...
      <section id="how-it-works" className="py-12 lg:py-16 bg-surface">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          ...
          <div ref={howItWorksRef} className="mt-16 relative">
            ...
            <div
              className="hidden lg:block absolute top-7 left-0 right-0 h-px overflow-hidden"
              ...
              {[
                {
                  ...
                  desc: "Tell us your industry, business size, and assets in a quick guided form.",
                },
                {
                  step: "02",
                  title: "Risk Scoring",
                  desc: "Our algorithm scores your risk exposure across fire, machinery, liability, and more.",
                },
                {
                  step: "03",
                  title: "Get Matched Policies",
                  desc: "Receive a curated shortlist of policies that fit your specific risk profile.",
                },
                {
                  step: "04",
                  title: "Compare & Apply",
                  desc: "Compare coverage, premiums, and insurers side-by-side, then apply directly.",
                },
              ].map((item, index) => (
                <div
                  key={item.step}
                  ...
                  <div
                    ...
                    style={{
                      ...
                      boxShadow: howItWorksVisible
                        ? "0 0 0 6px rgba(224,123,57,0.12)"
      ...
      <section className="py-12 lg:py-16 bg-background overflow-hidden">
        ...
        <div
          ...
          style={{
            width: "100%",
            maxWidth: visibleCards * cardWidth + (visibleCards - 1) * GAP,
          }}
      ...
      <section id="features" className="py-12 lg:py-16 bg-background">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="mt-3 text-lg lg:text-xl text-text-secondary">
              From risk analysis to policy matching, every step is designed to
              save you time and protect what matters.
            </p>
          </div>
      ...
      <section
        id="industries"
        className="relative overflow-hidden py-12 lg:py-16 bg-surface"
      >
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(13,115,119,0.14) 0%, rgba(13,115,119,0) 70%)",
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(224,123,57,0.14) 0%, rgba(224,123,57,0) 70%)",
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-10">
          ...
          >
            ...
            <p className="mt-3 text-lg lg:text-xl text-text-secondary">
              Tell us your industry once, and every recommendation is shaped
              around the risks your business actually faces.
            </p>
          </div>

          <div
            ref={industriesRef}
            className="mt-14 grid md:grid-cols-2 gap-6 lg:gap-8"
          >
            {/* Manufacturing card */}
            <div
              ...
              style={{
                ...
                transitionDelay: "0ms",
                boxShadow: industriesVisible
                  ? "0 4px 24px rgba(13,115,119,0.08)"
                  : "none",
              }}
            >
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, rgba(13,115,119,0.06) 0%, rgba(13,115,119,0) 55%)",
                }}
              />
              <div
              ...
              <h3 className="relative mt-6 text-3xl font-bold text-text-primary">
                Manufacturing
              </h3>
              <p className="relative mt-1.5 text-sm text-text-secondary">
                Protect what keeps production running:
              </p>
              <ul className="relative mt-5 grid grid-cols-2 gap-x-4 gap-y-3">
                {["Machinery", "Factory Assets", "Employees", "Inventory"].map(
                  (item, i) => (
                    <li
                      key={item}
              ...
              <a
                href="#features"
                className="relative mt-7 inline-flex items-center gap-1.5 text-sm font-semibold transition-colors duration-200"
                style={{ color: "var(--color-secondary)" }}
              >
            ...
            <div
              ...
              style={{
                ...
                boxShadow: industriesVisible
                  ? "0 4px 24px rgba(224,123,57,0.08)"
                  : "none",
              }}
            >
              <div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, rgba(224,123,57,0.07) 0%, rgba(224,123,57,0) 55%)",
                }}
              />
              <div
                className="absolute top-0 left-0 right-0 h-1.5"
                style={{
                  background:
                    "linear-gradient(90deg, var(--color-cta), #f0a878)",
                }}
              />
              ...
              <p className="relative mt-1.5 text-sm text-text-secondary">
                Protect what keeps customers coming back:
              </p>
              <ul className="relative mt-5 grid grid-cols-2 gap-x-4 gap-y-3">
                {["Shops", "Stock", "Equipment", "Staff"].map((item, i) => (
                  ...
                  >
                    <span
                      className="w-5 h-5 rounded-full flex items-center justify-center shrink-0"
                      style={{ background: "rgba(224,123,57,0.14)" }}
                    >
                      <svg
                        width="12"
                        height="12"
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div>
              ...
              <p className="mt-4 text-lg lg:text-xl text-text-secondary leading-relaxed">
                Have a question about your coverage, a claim, or which policy
                fits your business? Our AI assistant gives you clear answers in
                plain language, any time of day.
              </p>
                ...
                <div className="px-5 py-6 space-y-4 bg-background min-h-[280px]">
                  ...
                  <div className="flex justify-start">
                    <div className="max-w-[85%] rounded-lg px-4 py-2.5 text-sm bg-surface border border-border text-text-primary">
                      Yes — textile units handle flammable materials, so fire
                      insurance is strongly recommended. Based on similar
                      businesses, I'd suggest covering machinery and inventory
                      too.
                    </div>
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <div className="text-center">
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-x-12 gap-y-6">
              {[
                ...
                <span
                  key={name}
                  className="text-lg font-semibold text-text-tertiary/80 tracking-tight"
                >
                  {name}
                </span>
              ))}
          ...
          <div className="mt-12 grid md:grid-cols-3 gap-6">
            {[
              {
                quote:
                  "InsureTech helped me understand exactly what coverage my factory needed within minutes. No more guesswork.",
                name: "Ramesh Patel",
                role: "Owner, Textile Manufacturing Unit",
              },
              {
                quote:
                  "The AI assistant answered every question I had about claims. It felt like talking to an actual advisor.",
                name: "Sunita Mehra",
                role: "Founder, Retail Chain",
              },
              {
                quote:
                  "Comparing policies side-by-side saved us both time and money. The risk score was spot on for our business.",
                name: "Arjun Nair",
                role: "Director, Auto Parts Manufacturing",
              },
            ].map((t) => (
              <div
                key={t.name}
          ...
          <div className="grid lg:grid-cols-2 gap-14 lg:gap-20 items-start">
            ...
            <div className="lg:pt-6">
              ...
              <p className="mt-4 text-lg lg:text-xl text-white/70 max-w-md leading-relaxed">
                Get matched with the right insurance policies in minutes. No
                paperwork headaches, no guesswork — just clear, AI-backed
                recommendations.
              </p>
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-white/60">
                Have a question before you get started? Reach out directly or
                send us a message.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="mt-4 text-sm text-white/60 leading-relaxed max-w-md">
              AI-powered insurance advisory built for India's Manufacturing and
              Retail MSMEs.
            </p>
          </div>
