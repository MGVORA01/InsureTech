...
function NavItem({
  ...
  return (
    <button
      ...
      disabled={disabled}
      title={
        disabled ? "Complete risk assessment to unlock this feature" : undefined
      }
...
export function UserSidebar({
  ...
  const { recommendationUnlocked, comparisonUnlocked, chatbotUnlocked } =
    useNavigationLock();

  const navItems = [
    { section: "profile" as Section, icon: IconBuilding, label: "Dashboard" },
    {
      section: "profiling" as Section,
      icon: IconShield,
      label: "Risk Assessment",
    },
    {
      section: "recommendation" as Section,
      icon: IconSparkles,
      label: "Recommendation",
      disabled: !recommendationUnlocked,
    },
    {
      section: "comparison" as Section,
      icon: IconScale,
      label: "Policy Comparison",
      disabled: !comparisonUnlocked,
    },
    {
      section: "chatbot" as Section,
      icon: IconMessageCircle,
      label: "Chatbot",
      disabled: !chatbotUnlocked,
    },
    {
      section: "feedback" as Section,
...
export function UserMobileTopBar({
  onOpenDrawer,
  onLogout,
  onBack,
}: {
