    ...
    <Link
      ...
      style={{
        backgroundColor: active
          ? "var(--overlay-secondary-10, rgba(207,69,0,0.1))"
          : "transparent",
        color: active
          ? "var(--color-secondary)"
...
export function AdminDesktopSidebar({
  ...
  return (
    <aside
      className="sticky top-0 hidden h-screen shrink-0 lg:flex lg:w-64 lg:flex-col lg:border-r"
      style={{
...
export function AdminMobileTopBar({
  ...
  return (
    <div
      ...
      style={{
        backgroundColor: "var(--overlay-surface-80)",
        borderColor: "var(--color-border)",
      }}
    >
      <button
