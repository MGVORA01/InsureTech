...
export default function ComparisonChatPopUp({
  ...
  useEffect(() => {
    if (openSignal > 0 && compareParams.policy_id_a && compareParams.policy_id_b && hasComparison) {
      setOpen(true)
    }
  ...
  return (
    <>
      <button
        ...
        disabled={!compareParams.policy_id_a || !compareParams.policy_id_b || !hasComparison}
      >
